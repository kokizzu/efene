...
Efene is used as a library through a [rebar3](http://www.rebar3.org) plugin that is already available in efene rebar templates.
...
This section uses the project described in the [quickstart](quickstart.md) section.
...
Efene [commmon test](http://www.erlang.org/doc/man/common_test.html) task can be used as follows:
